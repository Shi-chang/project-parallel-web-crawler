...
public final class CrawlerConfiguration {
    ...
    /**
     * The desired parallelism (e.g., number of CPU cores) that should be used for the web crawl.
    ...
    public static final class Builder {
         ...
         *
         * <p>Does nothing if the same pattern has already been added. See
         * {@link #getIgnoredUrls()}.
         *
         ...
         *
         * <p>See {@link com.udacity.webcrawler.json.CrawlResult#getWordCounts()} for more
         * information
        ...
        /**
         * Overrides the {@link com.udacity.webcrawler.WebCrawler} implementation that should be
         * used for the crawl.
         *
