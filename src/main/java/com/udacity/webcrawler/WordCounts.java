...
final class WordCounts {
    ...
    /**
     * Given an unsorted map of word counts, returns a new map whose word counts are sorted
     * according to the provided {@link WordCountComparator}, and includes only the top
     ...
     * @return a map containing the top {@param popularWordCount} words and counts in the right
     * order.
     */
     ...
     * </ol>
     */
    private static final class WordCountComparator implements
